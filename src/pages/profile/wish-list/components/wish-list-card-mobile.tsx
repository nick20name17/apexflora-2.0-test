...
interface WishListProductCardMobileProps {
    shopProduct: ShopProduct
}
export const WishListProductCardMobile = ({
    shopProduct
}: WishListProductCardMobileProps) => {
    const {
        handleAddToWishList,
        priceWithDiscount,
    ...
    return (
        <article className='h-32 overflow-hidden rounded-sm border bg-background max-sm:flex max-sm:items-center sm:h-[270px]'>
            <div className='flex flex-col max-sm:w-full'>
                <div className='flex items-center justify-between gap-x-3 border-b px-2.5 pb-2.5 pt-4'>
                    <div className='flex items-center gap-x-2.5'>
                        ...
                        />
                        <div className='flex max-w-36 flex-col sm:max-w-40 md:max-w-52'>
