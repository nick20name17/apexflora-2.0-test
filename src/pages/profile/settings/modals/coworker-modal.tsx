...
import { removeCoworker } from '@/api/coworkers/coworkers'
...
export const RemoveCoworkerModal = ({ coworker }: { coworker: Coworker }) => {
    ...
    const removeCoworkerMutation = useMutation({
        mutationFn: (id: number) => removeCoworker(id),
        onSuccess: () => {
            setOpen(false)
        ...
        >
            ...
            <DialogContent>
                ...
                <div className='ml-auto flex items-center gap-x-4'>
                    <Button
                        className='w-24'
                        disabled={removeCoworkerMutation.isLoading}
                        onClick={() => removeCoworkerMutation.mutate(coworker.id)}
                        size='sm'
                        variant='destructive'
                    >
                        {removeCoworkerMutation.isLoading ? (
