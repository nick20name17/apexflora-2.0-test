...
export const PromoFilter = () => {
    const [promo = 'all', setPromo] = useQueryState('promo', {
        parse: (value: string) => {
            return value === 'all' ? null : value === 'promo' ? true : false
        }
    })
    ...
    return (
        <div>
            ...
            >
                {' '}
                З промо цін. / Без промо ціни
            </label>
            <Select
                value={promo === true ? 'promo' : promo === false ? 'no-promo' : 'all'}
                ...
                <SelectContent>
                    ...
                    <SelectItem value='promo'>
                        <div className='flex items-center gap-x-2'>
                            ...
                            <span> Товари з промо ціною</span>
                        </div>
                    </SelectItem>
