        ...
        <div className='rounded-xs border'>
            <div className='flex items-center justify-between gap-x-2 border-b p-2.5 pb-1.5'>
                <div className='flex items-center gap-x-2'>
                    ...
                    <div className='flex max-w-32 flex-col truncate'>
                ...
                <div className='itemc-center flex gap-x-2'>
                    <PriceCell
                        className='w-15'
            ...
            <div className='flex items-center justify-between gap-x-2 border-b p-2.5'>
                <div className='flex items-center gap-x-1'>
            ...
            <div className='flex items-center justify-between gap-x-2 p-2.5'>
