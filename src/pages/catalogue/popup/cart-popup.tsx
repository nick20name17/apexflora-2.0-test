...
export const CartPopup = () => {
    ...
    return (
        <div
            className={`fixed bottom-2 left-0 right-0 z-40 mx-auto flex h-14 w-[calc(100%-2rem)] max-w-md items-center justify-between gap-x-4 rounded-md bg-background/70 px-5 py-3 text-sm leading-tight shadow-md backdrop-blur-lg transition-all duration-300 ease-in-out max-xl:hidden sm:bottom-4 md:max-w-2xl xl:left-48 ${
                cartCount > 0
