    ...
    <DialogPortal>
        ...
        >
            ...
            <DialogPrimitive.Close
                ...
                className={cn(
                    'absolute right-4 top-4 rounded-sm ring-offset-background transition-all focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground',
